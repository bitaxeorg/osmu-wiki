...
Bitaxe Mini is prototype of the Bitaxe Family that includes four BM1370 ASIC currently. It's under development and is planned to use the next upcoming Bitmain ASIC chip.

This version will feature Ethernet directly on the PCB as well as additional debug ports for development.

**Currently there is no public repository as this is under active development** 
